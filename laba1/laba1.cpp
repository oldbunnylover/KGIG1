...
// laba1.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Claba1App, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &Claba1App::OnAppAbout)
END_MESSAGE_MAP()


// Создание Claba1App

Claba1App::Claba1App() noexcept
{
	...
	SetAppID(_T("laba1.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект Claba1App

Claba1App theApp;


// Инициализация Claba1App
...
// Обработчики сообщений Claba1App
